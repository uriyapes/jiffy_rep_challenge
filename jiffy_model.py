...
class Model(object):
    def __init__(self, dataset_name="libras", embed_vec_size=40):
        self.embed_vec_size = embed_vec_size
        self.dataset_name = dataset_name

    def get_dataset(self):
        if self.dataset_name == "libras":
            self.dataset = parse_libras.Dataset()
        elif self.dataset_name == "arabic digits":
...
if __name__ == '__main__':
    arabic_model = Model(dataset_name="arabic digits")
